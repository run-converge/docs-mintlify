...
| Attribution Model | Strenghts |  Weaknesses |
| --- | --- | --- |
...
The longer an average customer takes to convert the more undereported these channels will be.

**UTM-based attribution typically overreports conversions to search and brand traffic** 
Beceause UTM-based tracking might miss earlier sessions until conversion, it will tend to overreport channels that are later in the customer journey such as brand or search traffic.