...
<AccordionGroup>
    ...
    <Accordion title="Option 3: default to granting consent">
        If you have no CMP set up right now, Google defaults to process all data. If you want to ensure backwards compatibility with this behavior, you should explicitly pass this on to Google.
