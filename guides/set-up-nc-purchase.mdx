...
Even when you set up exclusions correctly, Meta usually does quite a lot of retargeting on existing customers. 
...
4. In Rules, choose URL, **doesn't contain** and fill in `doesnotexist` in the form field. Press "enter" after you fill in until you see your input become light grey. After that press **Create**.
   &nbsp;
    <Frame>
...
11. To add NC-ROAS, we need to create a custom metric, click on **Create custom metric**.
    &nbsp;
    <Frame>
