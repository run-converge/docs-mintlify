...
<Note> 
 **We recommend to centralize the tracking template into the account level settings and remove all tracking templates from your specific ads, ad groups and campaigns.** 
