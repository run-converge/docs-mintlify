...
1. Move to the ad for which you will set up tracking. Click on `Edit`.

2. In this section, there's a field URL parameters where you can paste the above snippet.
