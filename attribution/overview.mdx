...
1. Click on <IconText name="pencil" text="Edit overview" iconType="solid"/> in the top-right corner of the Overview dashboard
2. Click on the <Icon name="pencil"/>-icon next to the category of which you want to remove or add a card. 
...
1. Click on <IconText name="pencil" text="Edit overview" iconType="solid"/> in the top-right corner of the Overview dashboard
2. Click on the <Icon name="pencil"/>-icon next to the category of which you want to reorganize cards. 
