  ...
  <Steps>
    ...
    <Step title="Send a dummy event">
        ...
        5. Verify that your Webhook Source is working by sending a dummy [Placed Order](../converge-spec#placed-order)-event request. 
         ...
         <Note> You should fill in your own webhook endpoint from the Converge UI below</Note>
   <CodeGroup>
...
- `aliases`: Any b[aliurases](../source-concepts#aliases)


<AccordionGroup>

<Info> You can find Converge Python examples for the entire [Converge Spec here](../converge-spec) </Info>
