...
## Installation Instructions
  ...
  <Steps>
    ...
    <Step title="Send a dummy event">
        ...
        <Note>
            The Webhook Token has been added recenty to improve error messaging for easier issue diagnosis. Existing integrations that do not use a Webhook Token remain unaffected.
        </Note>
