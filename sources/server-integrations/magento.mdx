...
<AccordionGroup>
  ...
  <Steps>
    ...
    <Step title="Connect the Source to Magento">
        ...
        6. If your storefront is hosted on a different domain than your API, please provide the domain in the **Storefront domain**. Feel free to leave this blank if your store is hosted on the same domain.
    ...
    <Note> You should see the Source syncing all historical order data, you should wait until its fully synced to create connections </Note>
    </Accordion> 
