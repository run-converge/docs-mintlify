...
<AccordionGroup>
    ...
    <Steps>
       <Step title="Navigate to your WooCommerce REST API Settings">
        ...
        3. On the WooCommerce Settings Page, click on the **Advanced** tab in the topbar.
    ...
    <Step title="Generate your WooCommerce Consumer Key and Consumer Secret">
        ...
        6. Choose `Converge` for the **Decription**-form field, your own account as the **User**, and choose `Read` as the **Permissions**.
