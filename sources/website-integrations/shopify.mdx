...
<Tabs>
  ...
  <Steps>
    ...
    <Step title="Install the Converge Checkout as an extension in Shopify Customer Events">
        ...
        8. Paste the script from the web app here, and make sure to modify the `__SHOP_NAME__`string with the actual store name e.g. `convergestore`. You can find your store name in the URL of your Shopify Admin Dashboard.
