...
<Accordion title="Why do I have too little client-side events tracked on the Shopify Checkout">
  ...
  2. If **Regions** is set up, and you have a custom cookie banner, then Shopify might be blocking our pixel. Click on **Edit** and untick all countries, then press **Save**. 
