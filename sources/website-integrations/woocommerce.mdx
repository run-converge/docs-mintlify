...
The Converge Website installation for a WooCommerce store consists of:
  ...
  <Steps>
    ...
    <Step title="Install the WooCommerce Plugin">
        4. Download the WooCommerce Plugin by clicking on the folllowing link: <DownloadLink linkTarget="https://static.runconverge.com/converge_woocommerce.zip" linkText="Download Plugin"/>
