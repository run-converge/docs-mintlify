...
Converge supports cross-domain tracking out of the box. To enable cross-domain tracking from `myfirstdomain.com` to `myotherdomain.com`, include the following method together with the basic Converge pixel snippet on the `myfirstdomain.com` website. 
