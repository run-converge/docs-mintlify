...
[//]: # "This list of event properties and profile properties is WIP"

## Ecommerce Events

These events and properties should be passed for Ecommerce brands.
All of these events will contain additional prepopulated properties through [auto-tracking](http://localhost:3000/sources/converge-spec#auto-tracking).
