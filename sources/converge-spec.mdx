...
<Note> This event typically is used for stitching website sessions to server-side orders, make sure to add approppriate [aliases](/sources/concepts/aliases)</Note>
