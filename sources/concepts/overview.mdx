...
- <OutboundLink linkText="Profile properties" linkTarget="/sources/concepts/profile-properties"/>: to include browser-side information into the server-side order events.
