...
<Tab title="Google Ads"> 
  Pull in Ad Platform metrics from Google Ads using the [Google Ads integration](/attribution/ad-platforms/google-ads#installation-instruction).

</Tab>

<Tab title="Google Analytics 4"> 
  Pull in Ad Platform metrics from Google Analytics 4 using the [Google Analytics 4](/attribution/ad-platforms/ga4#installation-instruction).

</Tab>

<Tab title="TikTok Ads"> 
  Pull in Ad Platform metrics from TikTok Ads using the [TikTok Ads](/attribution/ad-platforms/tiktok#installation-instruction).
