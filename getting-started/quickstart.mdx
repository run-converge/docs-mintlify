...
<Tab title="Google Analytics 4"> 
  Send your customer events to Google Analytics 4 using the [Google Analytics 4](../connections/ga4#installation-instruction).

</Tab>

<Tab title="TikTok Ads"> 
  Send your customer events to TikTok Ads using the [TikTok Ads](../connections/tiktok#installation-instruction).
