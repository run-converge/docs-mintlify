...
<Note> The Pinterest Ad Platform integration allows you to see platform-specific metrics (e.g. Ad Spend) in Converge. 
...
2. **Navigate to the ad** which you will set up tracking as follows: `Ads` > `Reporting`.
...
<Note>
   **Metrics may show small discrepancies due to timezone differences.**

   The Pinterest Ads Manager always reports conversion data in `GMT+0` timezone.
   Converge interpolates the data to your workspace timezone which causes discrepancies in the data when directly comparing the Pinterest Ads Manager to Converge.
   
   The underlying data is being synced correctly.
   If you'd like to see the data in the `GMT+0` timezone, you can temporarily change the [Timezone Setting](/settings/workspace#timezone) in the Converge UI.
</Note>
