...
<Warning> Once you have installed your Converge Connection, you should **pause or remove all existing Snapchat tracking**. Leaving these on will lead to duplicate tracking. Check the [Turn off your old tracking setup](/guides/turn-off-tracking#snapchat-ads) guide for additional instructions. </Warning>
...
Converge automatically maps the following events from the [Converge Event Spec](/sources/converge-spec) to the Snapchat spec.

| Converge Event Name                                                                               | Snapchat Event Name                         |
| ------------------------------------------------------------------------------------------------- | --------------------------------------- |
