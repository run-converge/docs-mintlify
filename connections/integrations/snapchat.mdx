...
5. Fetch the acccess token for the conversions API. Go to the business dashboard > Business details > Conversions API tokens. Click the 'Generate Token' button and copy the new token into the Conversions API Token field of the Converge connection configuration.
