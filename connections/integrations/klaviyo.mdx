...
However, Klaviyo's browser identification is based on a third-party cookie meaning that most customers will not be successfully identified after 7 days (see our section on <OutboundLink linkText="Cookie Behaviour" linkTarget="/sources/concepts/aliases#default-cookie-behavior"/> ).
