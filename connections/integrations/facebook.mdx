...
<Accordion title="How do I use the NewCustomerPurchase event?">
  ...
  6. You cannot leave the 'Rules' section empty, but you should not filter out any events. Simply add a filter which is always true, e.g. `URL doesn't contain "does_not_exist"`.
