...
<Accordion title='Why do I see "increase event matching quality"-warnings in my Events Manager?'>
...
​Converge sends as many of these parameters as there are available right now.
...
For an `AddToCart` or an `InitiateCheckout`, you can safely ignore this warning.
</Accordion>
</AccordionGroup>
