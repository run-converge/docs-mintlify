...
1. The first thing we need to do in Google Cloud is set up a service account. Start by going to the sidebar menu and choosing _IAM and admin_ > _Service accounts_.
   &nbsp;
   <Frame>
...
7. Open your Converge Dashboard at [app.runconverge.com](https://app.runconverge.com) and navigate to the _Connections_ Tab. Click on <IconText name="circle-plus" text="Create New Connection" iconLocation="before" iconType="regular"/ >.
   &nbsp;
   <Frame>
