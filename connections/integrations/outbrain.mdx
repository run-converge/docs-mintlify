...
7. Choose the **Outbrain** app, and under the Outbrain event names section, fill in for which Converge event you want your conversion to correspond to. For this example, the **[Converge] Purchase**-conversion corresponds to a Converge **Placed Order**.
    <Frame>
