...
8. Add other conversion events in Tabooka following steps 2-6 above if you'd like and add them here as well. Then click **Create Connection**.

<Warning> For this connection to work, you will need to change the URL of **all** of your campaings following steps 9-12 below. **You should add these parameters for every new campaign as well**. </Warning>
