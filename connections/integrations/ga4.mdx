...
<Accordion title="How to configure cross-domain tracking in GA4?">
   If your customer journeys goes through multiple domains (e.g. landing pages or checkout on a different domain), it is important to configure this in GA4 to avoid broken customer journey reports.
