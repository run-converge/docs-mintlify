...
<Accordion title="Expand for more information">
  I.e. if the event properties looks like this:
...
<Accordion title="Why do I see a discrepancy between purchases in GA4 and Placed Orders in Converge?">
   ...
   2. Verify that you have no active <OutboundLink linkText="Filters" linkTarget="https://learn.runconverge.com/connections/filters"/> that are filtering out certain purchases. You can check this in the <OutboundLink linkText="Connection Logs" linkTarget="https://learn.runconverge.com/connections/monitoring#connection-logs"/>.
