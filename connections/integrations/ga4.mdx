...
See a deep-dive explanation as to how you can set up Custom Events for GA4 [here](/connections/custom-events#set-up-custom-events-for-your-connections).
...
<Steps>
 ...
 <Step title="Set up a custom definition in GA4">
   ...
   7. Fill in your desired **Dimension name** (this is how your dimension/property will show up in GA4), choose **Event** as your Scope. Optionally add a description and choose the mapped property that you set up in step 4 to fill in **Event parameter**.
