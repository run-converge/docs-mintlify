...
<Warning> Once you have installed your Converge Connection, you should **pause or remove all existing TikTok tracking**. Leaving these on will lead to duplicate tracking. Check the [Turn off your old tracking setup](/guides/turn-off-tracking#tiktok) guide for additional instructions. </Warning>
