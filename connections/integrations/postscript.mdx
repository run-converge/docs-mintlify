...
1. Create a Postscript API key in your Postscript dashboard. Select your Shop Name, go to API, click Create Security Key Pair and confirm by selecting Yes. Add a 'Converge' label and select Show to copy the Private Key.
