...
<Accordion title="Activate enhanced conversions" icon="sparkles">
   ...
   1. Navigate to your <OutboundLink linkText="Google Ads Conversions Overview" linkTarget="https://ads.google.com/aw/conversions"/> . If you have not set up enhanced conversions yet, you will see a prompt to set them up. Press **Apply**.
   &nbsp;
   <Frame>
   ![gads-enhanced-conv-1](/images/connections/google-ads/google-ads-enhanced-conversions-0.png)
   </Frame>

   2. Make sure you tick _Turn on enhanced conversions_ and choose **Google tag** as your method; then press **Save**.
   &nbsp;
   <Frame>
   ![gads-enhanced-conv-2](/images/connections/google-ads/google-ads-enhanced-conversions-1.png)
   </Frame>
