...
1. Navigate to the [Connections Tab](app.runconverge.com/connection) in your Converge dashboard
...
This status give you insight as to _how_ the Connection processed this data. 
